...
import { FaTaxi, FaStar } from 'react-icons/fa';
...
const TaxiCard = ({
    ...
    return (
        <motion.h1
            ...
            className="text-4xl text-red font-semibold text-center pb-4"
        ...
        >
            ...
            <div className='w-full rounded-xl p-5 border-2 border-neutral-300 space-y-4'>
                    ...
                    <div className="space-y-3">
                        <div className="w-full flex items-center justify-between">
                            <div className="flex items-center gap-x-3">
                                <FaTaxi className='h-5 w-5 text-red ' />
                ...
                <div className="w-full flex items-center justify-between">
                    ...
                    <Link to="/ticket/taxidetail" className="px-5 py-1.5 bg-red hover:bg-transparent border-2 border-red hover:border-red rounded-xl text-sm font-normal text-neutral-50 flex items-center justify-center gap-x-2 hover:text-red ease-in-out duration-300">
                        Reserve Seat
                    </Link>
                </div>
            </div>
