...
import RootLayout from '../../layout/RootLayout'; // Import the RootLayout component
import TopLayout from '../../layout/toppage/TopLayout'; // Import the TopLayout component
  ...
  return (
    <div className='w-full space-y-12 pb-16'>
      ...
      <TopLayout
        ...
        title={"Our Services"} // Title of the page
      />
      ...
      <RootLayout className="space-y-12 w-full pb-16">
        ...
        <div className="w-full flex flex-col items-center justify-center text-center">
          ...
          <p className="text-lg text-neutral-600 font-normal mt-4 px-4">
            We offer a variety of services to meet our customers' needs. Our services include:
          </p>
        </div>
